...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 table-bordered">
            <form method="post" action="/content/customers/meta">
                <input type="hidden" name="_METHOD" value="put">
                <input type="hidden" name="content_customers_say_id" value="<?=$content_customers_say_id?>">

                <div class="row">
                    <div class="col-sm-12 text-center"><h3>Edit Customers Say Entry</h3></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <a href="/content/customers" class="btn btn-default">Cancel</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">&nbsp;</div>
