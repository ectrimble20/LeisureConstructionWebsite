    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="fotorama" data-allowfullscreen="native" data-nav="thumbs">
                <?=$gallery_commercial_content?>
            </div>
        </div>
        <div class="col-lg-6">
            <!--Residential Gallery-->
            <div class="fotorama" data-allowfullscreen="native" data-nav="thumbs">
                <?=$gallery_residential_content?>
            </div>
        </div>
    </div>
    <br><br>
        ...
        <div class="col-sm-7">
            ...
            <div class="row">
                <div class="col-sm-6 form-group">
                    <input class="form-control" id="name" name="contact_name" placeholder="Name" type="text" required>
                </div>
                <div class="col-sm-6 form-group">
                    <input class="form-control" id="email" name="contact_email" placeholder="Email" type="email" required>
                </div>
            </div>
