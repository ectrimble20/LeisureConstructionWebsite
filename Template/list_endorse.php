...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <button id="btn-add-new" class="btn btn-default" data-toggle="modal" data-target="#modal-endorse"><span class="glyphicon glyphicon-plus"></span> New</button>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">&nbsp;</div>
...
<!-- MODAL NEW USER -->
<form role="form" method="post" action="/endorse">
    <div class="modal" id="modal-endorse" role="dialog">
